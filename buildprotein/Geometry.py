...
class ValGeo(Geo):
    ...
    def __init__(self):
        ...
        self.CG1_CB_CG2_angle = 110.5
        self.CG1_CA_CB_CG2_diangle = 122.6
...
class LeuGeo(Geo):
    ...
    def __init__(self):
        ...
        self.CD1_CG_CD2_angle = 110.5
        self.CD1_CB_CG_CD2_diangle = 122.6
...
class ThrGeo(Geo):
    ...
    def __init__(self):
        ...
        self.CB_CG2_length = 1.521
        self.OG1_CB_CG2_angle = 110.5
        self.OG1_CA_CB_CG2_diangle = -120
